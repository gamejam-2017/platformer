...
export default class IntroState extends Phaser.State {
  ...
  preload(game) {
    game.load.image('scene_1', 'assets/images/end/scene-1.png');
    game.load.image('scene_2', 'assets/images/end/scene-2.png');
    game.load.image('scene_3', 'assets/images/end/scene-3.png');
    game.load.image('scene_4', 'assets/images/end/scene-4.png');
  }
  create(game) {
  ...
  __changePicture() {
    ...
    if (this.current > 5) { // TODO Fix missing sprite bug
